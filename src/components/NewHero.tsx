    ...
    <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-500 to-cyan-400">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
        <div className="text-center">
          ...
          >
            Multi-disease classification framework powered by Federated Learning and Explainable AI
          </motion.h1>
          ...
          >
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button asChild size="lg" className="bg-white text-blue-600 hover:bg-slate-50 w-full sm:w-auto cursor-pointer">
                <Link to="/signup">
                  Get Started
                </Link>
              </Button>
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button size="lg" variant="outline" className="border-white !text-blue-600 hover:bg-white/10 hover:!text-white backdrop-blur-sm w-full sm:w-auto">
                Learn More
              </Button>
            </motion.div>
          </motion.div>
